...
function encryptFile($conn, $file_id, $shift)
{
    ...
    // Fetch file details and check permissions
    ...
    if (!$result || pg_num_rows($result) === 0) {
        ...
        return;  // Exit function if no file found or permission issue
    }
    ...
    // Define target directory and encrypted file name
    ...
    // Read file content and perform encryption
    ...
    // Insert encrypted file details in database
